...
- LinkedIn credentials must be stored in config.json in the AI_Employee_Vault directory
- The config.json file must contain a "linkedin" object with "email" and "password" fields
...
2. Extract login credentials from config.json
