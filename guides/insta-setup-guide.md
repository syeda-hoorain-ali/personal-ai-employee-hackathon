...
2. **Create New App**:
   ...
   - Fill in app details:
     - **App Name**: Choose a descriptive name (e.g., "Personal AI Employee MCP Server")
     - **App Contact Email**: Your email address
   - Click "Next"

3. **Add use cases**:
   - Click "Business messaging"
   - Select "Manage messaging & content on Instagram"
   - Click "Next"

4. **Business Portfolio**:
   - Select the Business Portfolio you want to connect
   - Click "Next" → "Next" → "Go to Dashboard"
...
1. **Configure Permissions**:
   - In your app dashboard, click "Customize the Manage messaging & content on Instagram use case"
...
### Step 5: Generate Access Token
   ...
   - In your app dashboard, click "App roles" -> "Roles"
   - Click "Add people", select "Instagraam tester"
   - Add your nistagram username -> click "Add"
   - Go to https://www.instagram.com/accounts/manage_access/ -> "Tester Invites" -> Accept invitation

   - In your app dashboard, click "Customize the Manage messaging & content on Instagram use case"
   - Expand "Generate access tokens", click "Generate TOken"
   - login with your instagram account -> "Allow" -> check "I understand"
...
2. **Configure Explorer**:
   ...
   - Select all permissions from the dropdown
   - Click "Generate Access Token"
   - Complate the remaing steps
...
1. **Set Up Facebook Login**:
   - In your app dashboard, click "Add use cases"
